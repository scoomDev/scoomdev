    ...
    private works: Work[] = [
        {
          ...
          description: `Le but de ce projet était de promouvoir les activités culturelles d'une ville de notre choix.
                        ...
                        La page d'accueil devait être essentiellement graphique et je devais prévoir une page
        ...
        },
        {
          ...
          description: `On introduit la POO avec PHP et les micro-framework avec Silex de SensioLabs. Ici, il s'agit de créer une
                        application de blog simple en PHP à l'aide de Silex en mettant en place une interface frontend pour la lecture
                        des billets et une interface backend pour administrer les billets de blog. On y retrouve donc tous les éléments
        ...
        },
        {
          ...
          description: `Le but était ici de reprendre le même type de projet que le blog créer lors du projet 3 de la formation
                        OpenclassRooms et de le porter sur la technologie Symfony. J'ai fait ce blog avant tout pour m'entrainer
                        sur cette techno, mais aujourd'hui, il est en ligne et actif, administré par un pote. Ce projet reprend
                        les concepts de CRUD et le design est également fait via Materialize.`,
        ...
        },
        {
          ...
          description: `Ici, on développe un backend en Symfony. Le but de ce projet était de proposer au client (fictif), le Louvre,
                        un nouveau système de réservation de billets en ligne afin de diminuer les longues files d'attente et
                        de tirer parti de l'usage des smartphones. L'interface doit donc être accessible sur tout type d'écran,
                        ...
                        du framework Bootstrap de Twitter et pour les paiements, j'utilise l'outil Stripe.`,
          info: null,
        ...
        },
        {
          ...
          context: 'Application d\'observation d\'oiseau.',
          description: `Michel Dujardin (personnage fictif), passionné d'ornithologie et fondateur de l'association NAO
                        (Nos Amis les Oiseaux), souhaite la création d'une application participative dans laquelle les
          ...
          info: `Sur ce projet, je me suis occupé du design, du frontend et du développement de quelques fonctionnalités, comme la
                galerie photo et quelques éléments liés à Google Maps.`,
        ...
        {
          id: 5,
          title: 'Meetlight V1 - P6 OCS',
          subtitle: 'Trouve ta lumière',
          context: `Contribuer à son écosystème !`,
          description: `Le but ici était de proposer un projet personnel qui contribue à son entourage.
                        Passionné de la photographie et ayant déjà rencontré certaines problématiques dans la création de projet
                        photographique, lié à la recherche de collaborateur par exemple, je me suis dit que c'était le meilleur
                        ...
                        proposer de collaborer sur un projet. L'objectif de Meetlight : devenir LE réseau social de la photographie
                        et ainsi permettre aux utilisateurs de se rencontrer et de collaborer.`,
          info: `Une version 2 sera prochainement développé en Symfony 4 et Angular. Aucun design n'est pour l'instant présent
                 je vais collaborer avec un UX Designer.`,
